                ...
                <div class="box-body">
                    <form class="form-horizontal" method="POST" id="formPassword">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="password" class="form-control" id="new_password_confirm" name="new_password_confirm" placeholder="Konfirmasi Kata Sandi">
	...
	<script type="text/javascript">
        ...
        // Submit Form setting
       	$('#formSetting').submit(function (event) {
	        ...
	        $('#formSetting .help-block').empty();
		 	...
		 	$.ajax({
                url: "{{ route('admin.profile.setting', ['id' => $data->id]) }}",
                method: 'POST',
                data: _data,
                cache: false,
		...
		$('#formPassword').submit(function (event) {
	        ...
	        $('#formPassword .help-block').empty();
		 	...
		 	$.ajax({
                url: "{{ route('admin.profile.password', ['id' => $data->id]) }}",
                method: 'POST',
                data: _data,
                cache: false,
