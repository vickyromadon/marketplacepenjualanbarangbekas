...
@section('content')
	<div class="row">
		<div class="col-md-4">
			<div class="box box-success">
				...
				<div class="box-body box-profile">
					...
					@else
						<img class="profile-user-img img-responsive" src="{{ asset('images/avatar_member.png') }}" alt="User profile picture" style="width: 150px; height: 150px;">
					@endif
		...
		<div class="col-md-8">
			<div class="box box-success">
				<div class="box-header">
					<h3 class="box-title">Biodata Member</h3>
				</div>
				<div class="box-body box-profile">
					<ul class="list-group list-group-unbordered">
						<li class="list-group-item">
