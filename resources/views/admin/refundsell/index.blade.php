...
@section('header')
	<h1>Daftar Pengembalian Dana Penjualan</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">Pengembalian Dana Penjualan</li>
	</ol>
@endsection
...
@section('content')
	<div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-cubes"></i> Pengembalian Dana Penjualan</h3>
            <form>
                <div class="row">
    ...
    <script>
        jQuery(document).ready(function($){
            ...
            var table = $('#refund_table').DataTable({
                ...
                "lengthChange": true,
                "ajax": {
                    "url": "{{ route('admin.refund_sell.index') }}",
                    "type": "POST",
                    "data" : function(d){
                        return $.extend({},d,{
                            'status' : $('#status').val(),
                ...
                "columns": [
                    ...
                    {
                        render : function(data, type, row){
                            return  '<a href="{{ route('admin.refund_sell.index') }}/'+ row.id +'" class="view-btn btn btn-xs btn-primary"><i class="fa fa-eye"> view</i></a>';
                        },
                        "width": "10%",
                        "orderable": false,
                    }
