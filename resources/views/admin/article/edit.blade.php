                    ...
                    <div class="modal-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="title" name="title" class="form-control" placeholder="Judul Artikel" value="{{ $data->title }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="link" name="link" class="form-control" placeholder="Link" value="{{ $data->link }}" required>
                                    <span class="help-block"></span>
                                </div>
                            </div>                           
                        </div>
