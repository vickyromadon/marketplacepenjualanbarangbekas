    ...
    <script>
        jQuery(document).ready(function($){
            ...
            $('#btnFinish').click(function () {
                url = '{{ route("admin.transaction_request.finish", ['id' => $transaction->id]) }}';
            ...
            $('#btnReject').click(function () {
                url = '{{ route("admin.transaction_request.reject", ['id' => $transaction->id]) }}';
            ...
            $('#btnApprove').click(function () {
                url = '{{ route("admin.transaction_request.approve", ['id' => $transaction->id]) }}';
