    ...
    <script>
        jQuery(document).ready(function($){
            ...
            var table = $('#transaction_table').DataTable({
                ...
                "lengthChange": true,
                "ajax": {
                    "url": "{{ route('admin.transaction_request.index') }}",
                    "type": "POST",
                    "data" : {}
                },
                "language": {
                ...
                "columns": [
                    ...
                    {
                        render : function(data, type, row){
                            return  '<a href="{{ route('admin.transaction_request.index') }}/'+ row.id +'" class="view-btn btn btn-xs btn-primary"><i class="fa fa-eye"> Lihat</i></a>';
                        },
                        "width": "10%",
                        "orderable": false,
                    }
