		...
		<div class="col-md-4">
			<div class="box box-danger">
				...
				<div class="box-body box-profile">
                    ...
                    @else
                        <img class="profile-user-img img-responsive img-circle" src="{{ asset('images/avatar_member.png') }}" alt="User profile picture">
                    @endif
					...
					<form class="form-horizontal" method="POST" id="formSetting" autocomplete="off">
						...
						<div class="form-group">
		                    <div class="col-sm-offset-3 col-sm-9">
		                      	<button type="submit" class="btn btn-danger" data-loading-text="<i class='fa fa-spinner fa-spin'></i>"><i class="fa fa-save"></i> Simpan</button>
		                    </div>
	                  	</div>
					</form>
				</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                    <img id="img-upload" src="{{ asset('images/avatar_member.png') }}" style="width: 200px; height: 150px;">
                                </div>
